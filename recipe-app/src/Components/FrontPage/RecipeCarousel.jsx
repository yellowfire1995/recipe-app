        ...
        <Carousel className="frontPage" touch indicators={false}>
          <Carousel.Item>
            <Link to="recipes/335" style={{ display: "contents" }}>
              <img
                ...
                src={`${IMAGES_HOST}/7c0c457b-fb52-4b70-a954-fe764388505b`}
              />
              <Carousel.Caption>
          ...
          <Carousel.Item>
            <Link to="recipes/127" style={{ display: "contents" }}>
              <img
                className="carousel-image"
                src={`${IMAGES_HOST}/9ad8cfad-3545-47f9-b010-cc86cf3da86b`}
              />
              <Carousel.Caption>
          ...
          <Carousel.Item>
            <Link to="recipes/329" style={{ display: "contents" }}>
              <img
                className="carousel-image"
                src={`${IMAGES_HOST}/8871f12d-d027-4b04-a5cf-b5d6fada0e00`}
              />
              <Carousel.Caption>
                <h3>Pita</h3>
              </Carousel.Caption>
